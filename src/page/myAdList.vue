            ...
            <el-table
                  ...
                  <template slot-scope="props">
                    <el-form label-position="left" inline class="demo-table-expand">
                      ...
                      <el-form-item label="广告介绍">
                        <span>{{ props.row.adDescription }}</span>
                      </el-form-item>
                      <el-form-item label="广告分类">
                        <span>{{ props.row.adType1 }}</span>
                      </el-form-item>
                      <el-form-item label="广告价值">
                        <span>{{ props.row.adCash }}</span>
                      </el-form-item>
                      <el-form-item label="投放数">
                        <span>{{ props.row.issueCount }}</span>
                      </el-form-item>
                      ...
                      <img v-if="props.row.adPicture" :src="props.row.adPicture" style="width: 200px;height: 450px;">
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                      <el-progress :percentage="scope.row.adProgress" :color="customColorMethod(scope.row.adProgress)"></el-progress>
                  </template>
                </el-table-column>
...
<script>
    ...
    import {getFoods, getFoodsCount, getMenu, updateFood, deleteFood, getResturantDetail, getMenuById, adList, timestampToTime, getUserTypeName, getShopOrAdTypeName} from '@/api/getData'
    export default {
        data(){
            return {
                baseUrl,
